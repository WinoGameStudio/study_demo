...
import { IAnimStateOptions } from "../../base/BaseAnimState";
import { BaseFSM } from "../../base/BaseFSM";
import { PlayerAnimBaseState } from "../../player/PlayerAnimBaseState";

;

export class EnemyBaseSubStateAnimFSM extends BaseFSM {
